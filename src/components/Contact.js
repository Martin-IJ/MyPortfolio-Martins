...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_cnepgxk', 'template_2n1q9gj', form.current, 'wKbZcLuKBCJMjCKhR')
      .then((result) => {
      ...
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row">
          ...
          className="flex-1 border rounded-2xl flex flex-col gap-y-6 pb-20 p-6 items-start">
            ...
            />
            <textarea className="bg-transparent border-b py-12 outline-none w-full placeholder:text-white/50 focus:border-accent transition-all resize-none mb-12" placeholder="Your message" name="message"></textarea>
